...
class livro{
    ...
    public function conectar(edtora,titulo_l,autor_l,ano_l,preco_l,quant_l,tipo_l)
            global $pdo;

            try {
                $conn = new pdo('mysql:host=' . HOST . ';port=' . PORT . ';dbname=' . edtora,titulo_l,autor_l,ano_l,preco_l,quant_l,tipo_l);
